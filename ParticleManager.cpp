...
XMFLOAT3 ParticleManager::eye = { 0, -0.5f, -5.0f };
XMFLOAT3 ParticleManager::target = { 0, 0.5f, 0 };
...
void ParticleManager::LoadTexture()
{
	...
	// WICテクスチャのロード
	result = LoadFromWICFile( L"Resources/blend.png", WIC_FLAGS_NONE, &metadata, scratchImg);
	assert(SUCCEEDED(result));
